...
Для обучения запускать скрипт go, он обучает 100 этох с размером бача 8. Как архитектуру использовали yolov5s для ускорения обучения и возможности использовать её непосредственно на борту безпилотника. 
